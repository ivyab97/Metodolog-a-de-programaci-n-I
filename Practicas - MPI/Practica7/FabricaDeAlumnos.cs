...
namespace Practica7
{
    public class FabricaDeAlumnos : FabricaDeComparables
    {
        ...
        public override Comparable crearAleatorio()
        {
            ...
            return new Alumno(Nombre_aleatorio.Nombre_azar(), manejador.numeroAleatorio(48000000), manejador.numeroAleatorio(50000), manejador.numeroAleatorio(10));
        }
        public Comparable crearAleatorioAlumnoME() 
        {
            setManejador(cadenaDeResponsabilidades());      //ejercicio2 - practica7
        ...
        public override Comparable crearPorArchivo()
        {
            ...
            Console.WriteLine("Ingrese el número de la línea del archivo para definir el Nombre y el DNI del alumno");
