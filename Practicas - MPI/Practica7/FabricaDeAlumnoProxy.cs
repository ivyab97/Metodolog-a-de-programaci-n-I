...
namespace Practica7
{
    public class FabricaDeAlumnoProxy : FabricaDeComparables
    {
        public override Comparable crearAleatorio()
        {
            ...
            return new AlumnoProxy(Nombre_aleatorio.Nombre_azar(), manejador.numeroAleatorio(46000000), manejador.numeroAleatorio(50000), manejador.numeroAleatorio(10), 1);
        }
        public override Comparable crearPorTeclado()
        {
            ...
            return new AlumnoProxy(Nombre, DNI, Legajo, Prom, 1);
        }
