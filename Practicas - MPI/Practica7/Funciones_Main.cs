...
namespace Practica7
{
    public class Funciones_Main
    {
        ...
        {
            Console.Write("Ingrese 1 para crear el comparable de forma aleatoria, 2 para crearlo por teclado o 3 para crearlo por archivo: ");
        ...
        public static void ejercicio3y4_practica7()       //ejercicio2_practica6 modificado para implementar los patrones change of responsability y Singleton
        {
            //Main
            ...
            for (int i = 0; i < 5; i++)
            {
                IComponenteAlumno A = (IComponenteAlumno)FabricaDeComparables.Crear_comparables(1, 1);  //Alumno (los crea aleatoriamente)

                //adapto a student los Alumnos
            ...
            for (int i = 0; i < 2; i++)
            {
                IComponenteAlumno AME = (IComponenteAlumno)FabricaDeComparables.Crear_comparables(5, 2); //AlumnoMuyEstudioso (los crea por teclado)
                
                //Adapto a student los AlumnoMuyEstudioso
            ...
            for (int i = 0; i < 5; i++)     //Agrego hijos al Compuesto de alumno
            {
                IComponenteAlumno A = (IComponenteAlumno)FabricaDeComparables.Crear_comparables(3, 3);  //AlumnoProxy   (los crea desde archivo)
                ((AlumnoCompuesto)alumnoCompuesto).agregarHijo(A);
            }
        ...
        {
            ManejadorObtencionDeDatos man1 = GeneradorDeDatosAleatorios.Get_instanciaUnica(null);
            ManejadorObtencionDeDatos man2 = LectorDeDatos.Get_instanciaUnica(man1);
            ManejadorObtencionDeDatos man3 = LectorDeArchivos.Get_instanciaUnica(man2);

            Console.WriteLine(man3.numeroDesdeArchivo(1));
            Console.WriteLine(man3.numeroDesdeArchivo(2234));
            Console.WriteLine(man3.numeroDesdeArchivo(4345));
            Console.WriteLine(man3.stringDesdeArchivo(2543));
            Console.WriteLine(man3.stringDesdeArchivo(2345));
            Console.WriteLine(man3.numeroDesdeArchivo(2345));
            Console.WriteLine(man3.stringDesdeArchivo(432));
            Console.WriteLine(man3.numeroDesdeArchivo(2234));
            Console.WriteLine(man3.numeroDesdeArchivo(4345));
        }
    }
